        ...
        <div className="relative px-4 pt-4 pb-6" style={{ background: "linear-gradient(180deg, #fff0eb 0%, #f5f5f5 100%)" }}>
          ...
          <div className="relative rounded-2xl overflow-hidden" style={{ backgroundColor: "#2196F3" }}>
            ...
            <div className="relative z-10 flex items-center justify-between px-5 py-5">
              <div>
                 <p className="text-white/80 text-sm">Claimed rewards</p>
                 <p className="text-white text-3xl font-black" data-testid="text-claimed-reward">{formatCurrency(claimedReward, user.country)}</p>
                <p className="text-white/70 text-xs mt-1">
                    Complete these tasks to earn {formatCurrency(totalReward, user.country)}
                </p>
              </div>
                ...
                >
                  ...
                  <div className="flex-1 min-w-0">
                    <p className="text-sm font-medium text-gray-800 truncate">{task.description}</p>
                      <p className="text-xs text-gray-400 mt-0.5">Reward: {formatCurrency(task.reward, user.country)}</p>
                  </div>
