      ...
      <div className="flex-1 overflow-y-auto pb-24 px-4 pt-4 space-y-3">
        ...
        >
          <div className="flex-1 text-center">
             <p className="text-white font-extrabold text-2xl">{formatCurrency(totalCommission, user.country)}</p>
            ...
            >
              ...
              <div className="flex-1 px-4 py-4">
                <p className="text-gray-700 text-xs text-center leading-snug mb-3">
                  Invite <span className="font-bold text-gray-900">{required}</span> level 1 investors to earn:{" "}
                   <span className="font-bold" style={{ color: "var(--teld-primary)" }}>{formatCurrency(reward, user.country)}</span>
                </p>
