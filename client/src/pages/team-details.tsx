  ...
  return (
    <div className="min-h-screen flex flex-col bg-gray-100">
      ...
      <div className="mx-3 mt-3 flex gap-3">
        ...
        {/* Deposits */}
        <div className="flex-1 bg-white rounded-2xl shadow-sm px-4 py-3">
          <p className="text-xs text-gray-400 mb-1">Team deposits</p>
          <p
          ...
          >
            {isLoading
              ? "—"
              : formatCurrency(Number(totalInvested), user?.country || "PH")}
          </p>
        </div>
      </div>
      ...
      <div className="mx-3 mt-3 mb-8 flex-1 space-y-2">
        {isLoading ? (
          ...
          <div className="bg-white rounded-2xl shadow-sm text-center py-10 px-6 flex flex-col items-center gap-2">
            <img src={emptyIllustration} alt="No team members" className="w-40 h-40 object-contain opacity-90" />
            <p className="text-gray-500 text-sm font-medium">
              No members at level {activeLevel}
            </p>
          ...
          members.map((member) => (
            ...
            >
              ...
              <div className="flex-1 min-w-0">
                ...
                >
                  Account: {maskPhone(member.phone)}
                </p>
              ...
              >
                {formatCurrency(Number(member.totalInvested), member.country || user?.country || "PH")}
              </p>
            </div>
          ))
        )}
