    ...
    <form onSubmit={form.handleSubmit(submitLabel === "Create" ? handleCreate : handleUpdate)} className="space-y-4">
      ...
      <div className="grid grid-cols-2 gap-4">
        ...
        <FormField control={form.control} name="dailyEarnings" render={({ field }) => (
          <FormItem>
            <FormLabel>Earnings/day (PHP)</FormLabel>
      ...
      {form.watch("price") && form.watch("dailyEarnings") && form.watch("cycleDays") && (
        <div className="bg-primary/10 rounded-lg p-3 text-sm">
          ...
          <p className="font-bold text-primary text-lg">
            {(parseInt(form.watch("dailyEarnings") || "0") * parseInt(form.watch("cycleDays") || "0")).toLocaleString("en-US")} PHP
          </p>
        </div>
      )}
            ...
            <CardContent className="p-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      {product.price.toLocaleString("en-US")} PHP — {product.dailyEarnings.toLocaleString("en-US")} PHP/day
                    </p>
                  </div>
                </div>
              ...
              <div className="grid grid-cols-3 gap-2 text-sm">
                <div>
                  ...
                  <p className="font-medium text-foreground">{product.price.toLocaleString("en-US")} PHP</p>
                </div>
                <div>
                  <p className="text-muted-foreground">Earnings/day</p>
                  <p className="font-medium text-foreground">{product.dailyEarnings.toLocaleString("en-US")} PHP</p>
                </div>
                <div>
                  <p className="text-muted-foreground">Total ({product.cycleDays} days)</p>
                  <p className="font-medium text-primary">{product.totalReturn.toLocaleString("en-US")} PHP</p>
                </div>
              </div>
            </CardContent>
          </Card>
